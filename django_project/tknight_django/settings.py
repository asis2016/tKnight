"""
Django settings for tknight_django project.
...
SECRET_KEY = 'django-insecure--5ksu=ggzb&oonv$&-k%0ld-##_41_x(+z+vwpn_5ct(w4bwme'
...
ROOT_URLCONF = 'tknight_django.urls'
...
WSGI_APPLICATION = 'tknight_django.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME':  f'{project_path}/db.sqlite3',
    }
}
